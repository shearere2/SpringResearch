...
if __name__ == "__main__":
    ...
    df = pd.read_csv('/Users/shearer/Desktop/SpringResearch/data/City_of_Pittsburgh_Neighborhoods/City_of_Pittsburgh_Neighborhoods.csv')
    ...
    fig = px.choropleth_mapbox(df, geojson=geojson, color="AREA",
